...
# the values will be generating in this part of the function.
...
" I will be creating a class  which will keep track of the balances"
...
# Over here we will be adding the transcations  to the ledge if it contains any suffiecnt funds.
    def add_transaction(self, transaction):
...
# We will get the last block in the blockchain and the last transcation in the block that is being added.
    def add_block(self, block):
       ...
       # Validates the integrity of the blockchain.
        # I am creating a string as well for the block hashes.
